                ...
                <div class="wrapper space-y-9">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="{{ route('admin-dinas-validasi-data') }}">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('admin-dinas/img/validasi data.png') }}" alt="validasi"
                            ...
                            <a href="{{ route('admin-dinas-lacak-permohonan') }}">
                                <div class="w-[265px] py-5 pl-5 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('admin-dinas/img/icon status permohonan.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="{{ route('admin-dinas-panduan-perizinan') }}">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('admin-dinas/img/icon panduan perizinan.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="{{ route('admin-dinas-monitoring') }}">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('admin-dinas/img/icon dashboard statistik.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('admin-dinas/img/pengesahan dokumen.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('admin-dinas/img/kelola sistem.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
