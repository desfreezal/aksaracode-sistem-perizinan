...
@section('content')
    <div class="text-edu-black my-8 mx-[50px]">
        ...
        <form action="{{ url('/dashboard-admin-dinas/status-permohonan/{id}') }}" method="GET" id="form-submit">
...
@push('scripts')
    <script>
        function submitForm() {
            ...
            window.location.href = '/dashboard-admin-dinas/status-permohonan/' + idPendaftaran; // Melakukan redirect
        }
        ...
        submitbtn.addEventListener('click', () => {
            if (id.value == '') {
                ...
                window.location.href = '/dashboard-admin-dinas/status-permohonan/' +
