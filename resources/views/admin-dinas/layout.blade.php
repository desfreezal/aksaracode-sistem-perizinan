...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-dinas/css/styles.css') }}" />
            ...
            <li>
                <div class="parent">
                    <a href="#" data-dropdown-toggle="notifDropDown">
                        <img class="images" src="{{ asset('admin-dinas/img/Notif Logo.png') }}" alt="Notif Logo"
                            style="width: 25px"></a>
                </div>
                ...
                <div id="notifDropDown"
                    ...
                    @else
                        ...
                        <div class="overflow-y-auto mx-5">
                            ...
                            <div onclick="window.location.href = '{{ route('admin-dinas-notifikasi') }}'"
