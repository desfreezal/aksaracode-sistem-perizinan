    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10" id="content">
                {{-- START KONTEN --}}
                <form action="{{ url('/dashboard-admin-dinas/profile') }}" method="POST" class="w-full space-y-6" id="form">
                    @csrf
                    @method('POST')
                    ...
                    <div class="flex items-center">
                        ...
                        <input readonly id="username" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->username }}"
                            name="username">
                    </div>
                    <div class="flex items-center">
                        <label for="email" class="w-72">Alamat Email</label>
                        <input readonly id="email" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->email }}"
                            name="email">
                    </div>
                    <div class="flex items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <input readonly id="jenkel" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->jenis_kelamin }}"
                            name="jenis_kelamin">
                    </div>
                    <div class="flex items-center">
                        <label for="tempatlahir" class="w-72">Tempat Lahir</label>
                        <input readonly id="tempatlahir" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->tempat_lahir }}"
                            name="tempat_lahir">
                    </div>
                    <div class="flex items-center">
                        <label for="tanggallahir" class="w-72">Tanggal Lahir</label>
                        <input readonly id="tanggallahir" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->tanggal_lahir }}"
                            name="tanggal_lahir">
                    </div>
                    <div class="flex items-center">
                        <label for="provinsi" class="w-72">Provinsi</label>
                        <input readonly id="provinsi" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->provinsi }}"
                            name="provinsi">
                    </div>
                    <div class="flex items-center">
                        <label for="kabkota" class="w-72">Kabupaten/ Kota</label>
                        <input readonly id="kabkota" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->kabupaten }}"
                            name="kabupaten">
                    </div>
                    <div class="flex items-center">
                        <label for="kecamatan" class="w-72">Kecamatan</label>
                        <input readonly id="kecamatan" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->kecamatan }}"
                            name="kecamatan">
                    </div>
                    <div class="flex items-center">
                        <label for="kelurahan" class="w-72">Kelurahan</label>
                        <input readonly id="kelurahan" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->kelurahan }}"
                            name="kelurahan">
                    </div>
                    <div class="flex items-center">
                        <label for="alamat" class="w-72">Alamat</label>
                        <input readonly id="alamat" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->alamat }}"
                            name="alamat">
                    </div>
                    <div class="flex items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <input readonly id="pekerjaan" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" value="{{ Auth::user()->pekerjaan }}"
                            name="pekerjaan">
                    </div>
