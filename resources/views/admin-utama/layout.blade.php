...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-utama/css/styles.css') }}" />
...
<body>
    ...
    <nav>
        ...
        <ul class="py-6 pr-6">
            <li>
                <div class="parent">
                    <a href="/dashboard-admin-utama">
                        Beranda
                    </a>
                </div>
            </li>
            <li>
                <a href="/dashboard-admin-utama/panduan-perizinan"
                    class="{{ Route::currentRouteName() === 'admin-utama-panduan-perizinan' ? 'text-primary' : '' }}">Panduan
                    Permohonan</a>
            </li>
            <li>
                <div class="parent">
                    <a href="#" data-dropdown-toggle="notifDropDown">
                        <img class="images" src="{{ asset('admin-utama/img/Notif Logo.png') }}" alt="Notif Logo"
                            style="width: 25px"></a>
                </div>
                ...
                <div id="notifDropDown"
                    ...
                    @else
                        ...
                        <div class="overflow-y-auto mx-5">
                            ...
                            <div onclick="window.location.href = '{{ route('admin-utama-notifikasi') }}'"
            ...
            <li>
                ...
                <div id="profileDropDown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 block"
                        ...
                        <li>
                            <a href="{{ route('admin-utama-profile') }}"
