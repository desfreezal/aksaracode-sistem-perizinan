...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('auditor/css/styles.css') }}" />
...
<body>
    ...
    <nav>
        ...
        <ul class="py-6 pr-6">
            ...
            <li>
                <a href="/dashboard-auditor/panduan-perizinan"
                    class="{{ Route::currentRouteName() === 'auditor-panduan-perizinan' ? 'text-primary' : '' }}">Panduan
                    Permohonan</a>
            </li>
            <li>
                <div class="parent">
                    <a href="#" data-dropdown-toggle="notifDropDown">
                        <img class="images" src="{{ asset('auditor/img/Notif Logo.png') }}" alt="Notif Logo"
                            style="width: 25px"></a>
                </div>
