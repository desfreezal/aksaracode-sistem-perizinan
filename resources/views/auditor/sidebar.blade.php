<div class="w-80 min-h-screen bg-edu-bg space-y-5 py-2 pt-16 pl-9 pr-12 box-border" id="sidebar">
    ...
    <a href="{{ route('auditor-monitoring') }}"
        ...
        {{ in_array(Route::currentRouteName(), ['auditor-monitoring', 'auditor-monitoring-detail']) ? 'bg-primary shadow text-white hover:bg-primary-light' : '' }} 
        group">
        <img src="{{ asset('sidebar/monitoring.png') }}"
            class="object-contain w-6 h-6 group-hover:filter-gray-to-white {{ in_array(Route::currentRouteName(), ['auditor-monitoring', 'auditor-monitoring-detail']) ? 'filter-gray-to-white' : '' }}"
            alt="1">
    ...
    <a href="{{ route('auditor-notifikasi') }}"
        ...
        <img src="{{ asset('sidebar/notifikasi.png') }}"
            class="object-contain w-6 h-6 group-hover:filter-gray-to-white  {{ Route::currentRouteName() === 'auditor-notifikasi' ? 'filter-gray-to-white' : '' }}"
            alt="1">
        <h1 class="text-sm uppercase font-normal">
            Notifikasi
        </h1>
