    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10" id="content">
                <div class="mb-9">
                    {!! Breadcrumbs::render('kepala-dinas-daftar-ulang', $peruntukan = request('peruntukan')) !!}
                </div>
                ...
                <form action="{{ route('kepala-dinas-detail-operasional') }}" method="GET" class="w-full space-y-6" id="form">
                    <input type="text" id="peruntukan" name="peruntukan" hidden>
                    <div class="flex items-center">
                        <label for="nik" class="w-72">NIK kepala-dinas</label>
                        <input id="nik" type="number" class="flex-grow text-edu-black border-abu-abu rounded"
                            name="nik">
                    </div>
                    <div class="flex items-center">
                        <label for="nama" class="w-72">Nama kepala-dinas</label>
