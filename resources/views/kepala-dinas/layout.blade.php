...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('kepala-dinas/css/styles.css') }}" />
...
<body>
    ...
    <nav>
        ...
        <ul class="py-6 pr-6">
            <li>
                <div class="parent">
                    <a href="/dashboard-kepala-dinas">
                        Beranda
                    </a>
                </div>
            </li>
            <li>
                <a href="/dashboard-kepala-dinas/panduan-perizinan"
                    class="{{ Route::currentRouteName() === 'kepala-dinas-panduan-perizinan' ? 'text-primary' : '' }}">Panduan
                    Permohonan</a>
            </li>
            <li>
                <a href="/dashboard-kepala-dinas/pengajuan-permohonan">Ajukan Permohonan</a>
            </li>
            <li>
                <a href="/dashboard-kepala-dinas/lacak-permohonan">Status Permohonan</a>
            </li>
            <li>
                <div class="parent">
                    <a href="#" data-dropdown-toggle="notifDropDown">
                        <img class="images" src="{{ asset('kepala-dinas/img/Notif Logo.png') }}" alt="Notif Logo"
                            style="width: 25px"></a>
                </div>
                ...
                <div id="notifDropDown"
                    ...
                    @else
                        ...
                        <div class="overflow-y-auto mx-5">
                            ...
                            <div onclick="window.location.href = '{{ route('kepala-dinas-notifikasi') }}'"
            ...
            <li>
                ...
                <div id="profileDropDown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 block"
                        ...
                        <li>
                            <a href="{{ route('kepala-dinas-riwayat-permohonan') }}"
