...
<option value="SMP">Daftar Ulang Izin Operasional Satuan Pendidikan SMP</option>
    ...
    @if (request('peruntukan') === 'tk')
        <div class="relative overflow-x-auto shadow-md">
            @include('kepala-dinas.panduan-perizinan.daftar-ulang.table-tk')
        </div>
    @elseif(request('peruntukan') === 'sd')
        <div class="relative overflow-x-auto shadow-md">
            @include('kepala-dinas.panduan-perizinan.daftar-ulang.table-sd')
        </div>
    @elseif(request('peruntukan') === 'smp')
        <div class="relative overflow-x-auto shadow-md">
            @include('kepala-dinas.panduan-perizinan.daftar-ulang.table-smp')
        </div>
    @endif
