@extends('kepala-dinas.panduan-perizinan.layout')
...
'Pilih Peruntukan' @endif"></span>
    ...
    <div class="my-5 flex justify-between items-center">
        ...
        <button
            ...
            Mengajukan Permohonan</button>
    </div>

    @if (request('peruntukan') === 'tk')
        <div class="relative overflow-x-auto shadow-md">
            @include('kepala-dinas.panduan-perizinan.izin-operasional.table-tk')
        </div>
    @elseif(request('peruntukan') === 'sd')
        <div class="relative overflow-x-auto shadow-md">
            @include('kepala-dinas.panduan-perizinan.izin-operasional.table-sd')
        </div>
    @elseif(request('peruntukan') === 'smp')
        <div class="relative overflow-x-auto shadow-md">
            @include('kepala-dinas.panduan-perizinan.izin-operasional.table-smp')
        </div>
    @endif
