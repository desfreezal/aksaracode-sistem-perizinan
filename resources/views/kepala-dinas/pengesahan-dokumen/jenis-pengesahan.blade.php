        ...
        <div class="flex">
            ...
            <div class="flex-grow pl-[34px] pr-[88px] py-7 box-border min-h-screen" id="content">
                <div class="h-full flex flex-col justify-center items-center space-y-16 pt-10">
                    {{-- CARD --}}
                    <a
                        href="{{ route('kepala-dinas-data-pengesahan', ['layanan' => 'daftar-ulang-izin-operasional', 'jenis' => $jenis]) }}">
                    ...
                    <a
                        href="{{ route('kepala-dinas-data-pengesahan', ['layanan' => 'izin-pendirian', 'jenis' => $jenis]) }}">
                        <div class=" flex items-center max-w-md rounded-3xl bg-primary text-white">
                    ...
                    <a
                        href="{{ route('kepala-dinas-data-pengesahan', ['layanan' => 'izin-operasional', 'jenis' => $jenis]) }}">
                        <div class=" flex items-center max-w-md rounded-3xl bg-primary text-white">
