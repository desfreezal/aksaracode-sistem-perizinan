        ...
        <div class="flex">
            ...
            <div class="flex-grow pl-[34px] pr-[88px] py-7 box-border" id="content">
                ...
                <div class="rounded-lg flex items-center gap-x-8 px-5 py-3 shadow-xl mb-4">
                    <img src="{{ asset('operator/img/notif white.png') }}" alt="valid"
                ...
                <div class="flex">
                    ...
                    <div class="w-80 py-2 border-edu-black border-r-2 min-h-[calc(100vh-200px)]" id="sidebar">
                        ...
                        <div class="mt-3 space-y-3">
                            {{-- PILIH BUBBLE CHAT --}}
                            <a href="{{ route('operator-detail-chatting', ['id_user' => 1]) }}">
                                <div
                            ...
                            <a href="{{ route('operator-detail-chatting', ['id_user' => 2]) }}">
                                <div
                            ...
                            <a href="{{ route('operator-detail-chatting', ['id_user' => 3]) }}">
                                <div
