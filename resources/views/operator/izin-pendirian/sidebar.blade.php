<div x-data="{ isOpen: false }" :class="isOpen ? 'w-80' : 'w-20'" class=" min-h-screen relative space-y-3 py-2 duration-500"
    ...
    <div x-show.transition.duration.500ms="isOpen" class="sidebar-content w-80 transition-all">
        <a href="/dashboard-operator/izin-pendirian"
            class="cursor-pointer flex items-center pl-11 w-full {{ Route::currentRouteName() === 'operator-izin-pendirian' ? 'bg-white shadow' : '' }} hover:bg-white gap-x-3 py-2">
        ...
        <a href="#"
            class="cursor-pointer flex items-center pl-11 w-full {{ Route::currentRouteName() === 'operator-detail-yayasan' ? 'bg-white shadow' : '' }} hover:bg-white hover:shadow gap-x-3 py-2">
        ...
        <a href="#"
            class="cursor-pointer flex items-center pl-11 w-full {{ Route::currentRouteName() === 'operator-detail-pendirian' ? 'bg-white shadow' : '' }} hover:bg-white hover:shadow gap-x-3 py-2">
            <img src="{{ asset('admin-dinas/img/Check list.png') }}" class="object-contain" alt="1">
            <h1 class="text-base font-normal text-edu-black">
                Detail Pendirian
            </h1>
        ...
        <a href="#"
            class="cursor-pointer flex items-center pl-11 w-full hover:bg-white {{ Route::currentRouteName() === 'operator-upload-berkas' ? 'bg-white shadow' : '' }}  hover:shadow gap-x-3 py-2">
