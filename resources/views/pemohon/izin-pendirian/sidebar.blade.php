<div class="w-80 min-h-screen relative bg-edu-bg space-y-3 py-2" id="sidebar">
    ...
    <a href="#"
        class="cursor-pointer flex items-center pl-11 w-full {{ Route::currentRouteName() === 'pemohon-detail-yayasan' ? 'bg-white shadow' : '' }} hover:bg-white hover:shadow gap-x-3 py-2">
    ...
    <a href="#"
        class="cursor-pointer flex items-center pl-11 w-full {{ Route::currentRouteName() === 'pemohon-detail-pendirian' ? 'bg-white shadow' : '' }} hover:bg-white hover:shadow gap-x-3 py-2">
        <img src="{{ asset('pemohon/img/Check list.png') }}" class="object-contain" alt="1">
        <h1 class="text-base font-normal text-edu-black">
            Detail Pendirian
        </h1>
    ...
    <a href="#"
        class="cursor-pointer flex items-center pl-11 w-full hover:bg-white {{ Route::currentRouteName() === 'pemohon-upload-berkas' ? 'bg-white shadow' : '' }}  hover:shadow gap-x-3 py-2">
