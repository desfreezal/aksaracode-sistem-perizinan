...
'Pilih Peruntukan' @endif"></span>
    ...
    @if (request('peruntukan') === 'tk')
        <div class="relative overflow-x-auto shadow-md">
            @include('pemohon.panduan-perizinan.izin-operasional.table-tk')
        </div>
    @elseif(request('peruntukan') === 'sd')
        <div class="relative overflow-x-auto shadow-md">
            @include('pemohon.panduan-perizinan.izin-operasional.table-sd')
        </div>
    @elseif(request('peruntukan') === 'smp')
        <div class="relative overflow-x-auto shadow-md">
            @include('pemohon.panduan-perizinan.izin-operasional.table-smp')
        </div>
    @endif
