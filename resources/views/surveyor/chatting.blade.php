                ...
                <div class="flex">
                    ...
                    <div class="w-80 py-2 border-edu-black border-r-2 min-h-[calc(100vh-200px)]" id="sidebar">
                        ...
                        <div class="mt-3 space-y-3">
                            {{-- PILIH BUBBLE CHAT --}}
                            <a href="{{ route('surveyor-detail-chatting', ['id_user' => 1]) }}">
                                <div
                                    ...
                                    <div class="space-y-1">
                                        <h1 class="font-semibold text-xl">surveyor</h1>
                                        <p class="">Permohonan anda sedang diproses</p>
                                    </div>
                                </div>

                            </a>
                            <a href="{{ route('surveyor-detail-chatting', ['id_user' => 2]) }}">
                                <div
                            ...
                            <a href="{{ route('surveyor-detail-chatting', ['id_user' => 3]) }}">
                                <div
