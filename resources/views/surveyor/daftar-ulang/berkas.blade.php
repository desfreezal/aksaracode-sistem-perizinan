    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10 w-full" id="content">
                <div class="mb-9">
                    {!! Breadcrumbs::render('surveyor-berkas-daftar', $peruntukan = request('peruntukan')) !!}
                </div>
                ...
                <form action="{{ url('/dashboard-surveyor/daftar-ulang/berkas') }}" method="GET" class="w-full space-y-6" id="form">
                    @if (request('peruntukan') === 'tk')
                        @include('surveyor.daftar-ulang.berkas-daftar-ulang.table-tk')
                    @elseif (request('peruntukan') === 'sd')
                        @include('surveyor.daftar-ulang.berkas-daftar-ulang.table-sd')
                    @elseif (request('peruntukan') === 'smp')
                        @include('surveyor.daftar-ulang.berkas-daftar-ulang.table-smp')
                    @else
