...
<html>
  ...
  <body>
    ...
    <nav>
      <div class="">
        <img src="{{asset('surveyor/img/EduLicense fix 3.png')}}" alt="Logo EduLicense" />
      </div>
      <ul>
        <li>
          <div class="parent">
            ...
            <img
            class="images"
              src="{{asset('surveyor/img/Notif Logo.png')}}"
              alt="Notif Logo"
              style="width: 25px"
            ></a>
          </div>
        ...
        <li>
          <a href="#"
            ><img
              src="{{asset('surveyor/img/Profil Logo.png')}}"
              alt="Logo Profil"
              style="width: 25px"
            /></a
          >
