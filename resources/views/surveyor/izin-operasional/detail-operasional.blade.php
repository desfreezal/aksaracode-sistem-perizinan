    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10" id="content">
                <div class="mb-9">
                    {!! Breadcrumbs::render('surveyor-detail-operasional', $peruntukan = request('peruntukan')) !!}
                </div>
                {{-- CONTENT --}}
                ...
                <form action="{{ route('surveyor-berkas-operasional') }}" method="GET" class="w-full space-y-6" id="form">
                    ...
                    <div class="flex items-center">
                        <label for="nosuratsurveyor" class="w-72">No Surat surveyor</label>
                        <input id="nosuratsurveyor" type="text" class="flex-grow text-edu-black border-abu-abu rounded"
                            name="nosuratsurveyor">
                    </div>
                    <div class="flex items-center">
                        <label for="tglsuratsurveyor" class="w-72">Tanggal Surat surveyor</label>
                        <input id="tglsuratsurveyor" type="text" class="flex-grow text-edu-black border-abu-abu rounded"
                            name="tglsuratsurveyor">
                    </div>
                    <div class="flex items-center">
