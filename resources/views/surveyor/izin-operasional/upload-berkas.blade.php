    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10 w-full" id="content">
                ...
                <div class="mb-9">
                    {!! Breadcrumbs::render('surveyor-berkas-operasional', $peruntukan = request('peruntukan')) !!}
                </div>
                {{-- CONTENT --}}
                ...
                <form action="{{ route('surveyor-berkas-operasional') }}" method="GET"
                    class="w-full space-y-6" id="form">
                    @if (request('peruntukan') === 'tk')
                        @include('surveyor.izin-operasional.berkas-izin-operasional.table-tk')
                    @elseif (request('peruntukan') === 'sd')
                        @include('surveyor.izin-operasional.berkas-izin-operasional.table-sd')
                    @elseif (request('peruntukan') === 'smp')
                        @include('surveyor.izin-operasional.berkas-izin-operasional.table-smp')
                    @else
                        @include('surveyor.izin-operasional.berkas-izin-operasional.table-sd')
                    @endif
