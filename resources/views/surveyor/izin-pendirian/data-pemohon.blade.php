...
@section('content')
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            {{-- SIDEBAR --}}
            @include('surveyor.izin-pendirian.sidebar')

            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10" id="content">

                <div class="mb-9">
                    {!! Breadcrumbs::render('surveyor-daftar-ulang') !!}
                </div>
                {{-- CONTENT --}}
                ...
                <form action="{{ url('/dashboard-surveyor/izin-pendirian/detail-yayasan') }}" method="GET" class="w-full space-y-6" id="form">
