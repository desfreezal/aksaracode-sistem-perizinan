...
<body>
    ...
    <nav>
        ...
        <ul class="py-6 pr-6">
            ...
            <li>
                <a href="/dashboard-surveyor/panduan-perizinan"
                    class="{{ Route::currentRouteName() === 'surveyor-panduan-perizinan' ? 'text-primary' : '' }}">Panduan
                    Permohonan</a>
            </li>
            <li>
                <a href="/dashboard-surveyor/pengajuan-permohonan">Ajukan Permohonan</a>
            </li>
            <li>
                <a href="/dashboard-surveyor/lacak-permohonan">Status Permohonan</a>
            </li>
            <li>
                <div class="parent">
