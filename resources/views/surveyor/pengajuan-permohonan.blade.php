...
@section('content')
    <div class="mx-36 mt-5 min-h-screen">
        <div class="mb-9">
            {!! Breadcrumbs::render('surveyor-dashboard') !!}
        </div>
        ...
        <div id="card-container" class="flex items-center gap-x-6">
            ...
            <div class="w-[234px] min-h-[267px] pt-4 bg-primary rounded-[36px] box-border">
                <a href="{{ route('surveyor-daftar-ulang') }}">
            ...
            <div class="w-[234px] min-h-[267px] pt-4 bg-primary rounded-[36px] box-border">
                <a href="{{ route('surveyor-izin-pendirian') }}">
                    <div class="mx-11 px-6 py-5 rounded-full bg-edu-bg">
            ...
            <div class="w-[234px] min-h-[267px] pt-4 bg-primary rounded-[36px] box-border">
                <a href="{{ route('surveyor-izin-operasional') }}">
                    <div class="mx-11 px-6 py-5 rounded-full bg-edu-bg">
    ...
    {{-- <div class="container-kotak-cokelat" style="gap: 10px; margin: 80px 50px">
        <div class="kotak-cokelat">
            <div class="daftar-ulang">
                ...
                <div class="tombol-putih">
                    <a href="{{ route('surveyor-daftar-ulang') }}">Daftar Ulang Izin Operasional Satuan Pendidikan</a>
                </div>
            </div>
        </div>
        <div class="kotak-cokelat-1">
            <div class="izin-pendirian">
                ...
                <div class="tombol-putih">
                    <a href="{{ route('surveyor-izin-pendirian') }}">Izin Pendirian Satuan Pendidikan</a>
                </div>
            </div>
        </div>
        <div class="kotak-cokelat-2">
            <div class="izin-operasional">
                ...
                <div class="tombol-putih">
                    <a href="{{ route('surveyor-izin-operasional') }}">Izin Operasional Satuan Pendidikan</a>
                </div>
            </div>
        </div>
    </div> --}}
