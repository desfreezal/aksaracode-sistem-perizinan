    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10" id="content">
                <div class="mb-9">
                    {!! Breadcrumbs::render('verifikator-detail-daftar', $peruntukan = request('peruntukan')) !!}
                </div>
                ...
                <form action="{{ url('/dashboard-verifikator/daftar-ulang/berkas') }}" method="GET" class="w-full space-y-6" id="form">
                    ...
                    <div class="flex items-center">
                        <label for="nosuratverifikator" class="w-72">No Surat verifikator</label>
                        <input id="nosuratverifikator" type="text" class="flex-grow text-edu-black border-abu-abu rounded"
                            name="nosuratverifikator">
                    </div>

                    <div class="flex items-center">
                        <label for="tglsuratverifikator" class="w-72">Tanggal Surat verifikator</label>
                        <input id="tglsuratverifikator" type="text"
                            class="flex-grow text-edu-black border-abu-abu rounded" name="tglsuratverifikator">
                    </div>
