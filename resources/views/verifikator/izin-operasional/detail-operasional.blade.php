    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10" id="content">
                <div class="mb-9">
                    {!! Breadcrumbs::render('verifikator-detail-operasional', $peruntukan = request('peruntukan')) !!}
                </div>
                {{-- CONTENT --}}
                ...
                <form action="{{ route('verifikator-berkas-operasional') }}" method="GET" class="w-full space-y-6" id="form">
                    ...
                    <div class="flex items-center">
                        ...
                        <input id="tglsuratverifikator" type="text" class="flex-grow text-edu-black border-abu-abu rounded"
                            name="tglsuratverifikator">
                    </div>
                    <div class="flex items-center">
