    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10" id="content">
                <div class="mb-9">
                    {!! Breadcrumbs::render('verifikator-izin-pendirian', $peruntukan = request('peruntukan')) !!}
                </div>
                ...
                <form action="{{ url('/dashboard-verifikator/izin-pendirian/detail-pendirian') }}" method="GET"
