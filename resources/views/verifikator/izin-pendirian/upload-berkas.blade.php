    ...
    <div class="min-h-screen h-full">
        ...
        <div class="flex">
            ...
            <div class="flex-grow h-full pl-[34px] pr-[88px] py-7 box-border mb-10 w-full" id="content">
                <div class="mb-9">
                    {!! Breadcrumbs::render('verifikator-izin-pendirian-berkas', $peruntukan = request('namasekolah')) !!}
                </div>
                {{-- CONTENT --}}
                ...
                <form action="{{ url('/dashboard-verifikator/izin-pendirian/upload-berkas') }}" method="GET"
                    ...
                    @if (request('peruntukan') === 'tk')
                        @include('verifikator.izin-pendirian.berkas-izin-pendirian.table-tk')
                    @elseif (request('peruntukan') === 'sd')
                        @include('verifikator.izin-pendirian.berkas-izin-pendirian.table-sd')
                    @elseif (request('peruntukan') === 'smp')
                        @include('verifikator.izin-pendirian.berkas-izin-pendirian.table-smp')
                    @else
                        @include('verifikator.izin-pendirian.berkas-izin-pendirian.table-sd')
                    @endif
