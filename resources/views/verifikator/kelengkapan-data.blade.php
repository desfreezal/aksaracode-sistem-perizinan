                ...
                <div class="wrapper space-y-9">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="{{ route('verifikator-validasi-data') }}">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('verifikator/img/validasi data.png') }}" alt="validasi"
                            ...
                            <a href="{{ route('verifikator-lacak-permohonan') }}">
                                <div class="w-[265px] py-5 pl-5 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('verifikator/img/icon status permohonan.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="{{ route('verifikator-panduan-perizinan') }}">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('verifikator/img/icon panduan perizinan.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="{{ route('verifikator-monitoring') }}">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('verifikator/img/icon dashboard statistik.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('verifikator/img/pengesahan dokumen.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-x-8">
                            <a href="">
                                <div class="w-[265px] py-5 pl-5 pr-12 shadow-xl flex items-center gap-x-8 rounded-lg">
                                    <img src="{{ asset('verifikator/img/kelola sistem.png') }}" alt="validasi"
                                        class="bg-primary p-3 aspect-square object-contain rounded-xl w-12">
