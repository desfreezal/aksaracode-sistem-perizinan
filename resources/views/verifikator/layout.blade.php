...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('verifikator/css/styles.css') }}" />
...
<body>
    ...
    <nav>
        ...
        <ul class="py-6 pr-6">
            <li>
                <div class="parent">
                    <a href="/dashboard-verifikator">
                        Beranda
                    </a>
                </div>
            </li>
            <li>
                <a href="/dashboard-verifikator/panduan-perizinan"
                    class="{{ Route::currentRouteName() === 'verifikator-panduan-perizinan' ? 'text-primary' : '' }}">Panduan
                    Permohonan</a>
            </li>
            <li>
                <a href="/dashboard-verifikator/pengajuan-permohonan">Ajukan Permohonan</a>
            </li>
            <li>
                <a href="/dashboard-verifikator/lacak-permohonan">Status Permohonan</a>
            </li>
            <li>
                <div class="parent">
                    <a href="#" data-dropdown-toggle="notifDropDown">
                        <img class="images" src="{{ asset('verifikator/img/Notif Logo.png') }}" alt="Notif Logo"
                            style="width: 25px"></a>
                </div>
                ...
                <div id="notifDropDown"
                    ...
                    @else
                        ...
                        <div class="overflow-y-auto mx-5">
                            ...
                            <div onclick="window.location.href = '{{ route('verifikator-notifikasi') }}'"
